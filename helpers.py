...
def spending_money_savings_target_balance(
    ...
    calculation_month_pay_day_count \
        = weekdays_in_range(
            pay_day,
    ...
    if debug:
        print(f"Calculation Month Pay Day Count: {calculation_month_pay_day_count}")  # noqa
    ...
    target_balance \
        = (monthly_saving_amount * payments_in) \
